        ...
        <section id="featured-products">
          ...
          <div className="product-list">
            <div className="product-card" data-product-id="product1">
              <img src="images/hair_oil_1.jpeg" alt="Herbal Hair Oil 1" />
            ...
            <div className="product-card" data-product-id="product2">
              <img src="images/skin_cream_1.jpeg" alt="Ayurvedic Skin Cream 1" />
      ...
      <section id="additional-products">
        ...
        <div className="product-list">
          <div className="product-card" data-product-id="product3">
            <img src="images/hair_oil_1.jpeg" alt="Herbal Hair Oil 2" />
          ...
          <div className="product-card" data-product-id="product4">
            <img src="images/skin_cream_1.jpeg" alt="Ayurvedic Skin Cream 2" />
      ...
      <section id="app-download-section">
        <div className="app-content-left">
          ...
          <div className="feature-boxes">
            <div className="feature-box">
              <img src="images/app-section/icon-prescription.png" alt="Access To Prescriptions icon" />
              <span>Access To Prescriptions</span>
            </div>
            <div className="feature-box">
              <img src="images/app-section/icon-health.png" alt="Track Health Efficiently icon" />
              <span>Track Health Efficiently</span>
            </div>
            <div className="feature-box">
              <img src="images/app-section/icon-chat.png" alt="Direct Chat With Doctors icon" />
              <span>Direct Chat With<br />Doctors</span>
            </div>
            <div className="feature-box">
              <img src="images/app-section/icon-reminder.png" alt="In-App Reminders icon" />
        ...
        <div className="app-content-right">
          <div className="phone-mockup">
            <img src="images/app-section/phone-mockup.png" alt="Phone App Mockup" />
            <div className="engagement-time">
              <span>Engagement Time</span>
              <strong>6m 33s</strong>
              <img src="images/app-section/engagement-graph.png" alt="Engagement graph" />
            </div>
            <div className="downloads-card">
              <img src="images/app-section/user-avatars.png" alt="User avatars" />
